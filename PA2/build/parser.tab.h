...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_FLOAT_LIT = 260,             /* T_FLOAT_LIT  */
    T_BOOL_LIT = 261,              /* T_BOOL_LIT  */
    T_INT = 262,                   /* T_INT  */
    T_FLOAT = 263,                 /* T_FLOAT  */
    T_BOOL = 264,                  /* T_BOOL  */
    T_VOID = 265,                  /* T_VOID  */
    ...
    T_OR = 287,                    /* T_OR  */
    T_NOT = 288,                   /* T_NOT  */
    T_INCREMENT = 289,             /* T_INCREMENT  */
    T_DECREMENT = 290,             /* T_DECREMENT  */
    T_STREAM_IN = 291,             /* T_STREAM_IN  */
    T_STREAM_OUT = 292,            /* T_STREAM_OUT  */
    T_LPAREN = 293,                /* T_LPAREN  */
    T_RPAREN = 294,                /* T_RPAREN  */
    T_LBRACE = 295,                /* T_LBRACE  */
    T_RBRACE = 296,                /* T_RBRACE  */
    T_LBRACKET = 297,              /* T_LBRACKET  */
    T_RBRACKET = 298,              /* T_RBRACKET  */
    T_SEMI = 299,                  /* T_SEMI  */
    T_COMMA = 300,                 /* T_COMMA  */
    T_ERROR = 301                  /* T_ERROR  */
  };
