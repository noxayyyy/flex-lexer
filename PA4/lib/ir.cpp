...
void print_ir_list(IRInst* head) {
	...
	while (current) {
		switch (current->op) {
		case IR_ADD:
			cout << "ADD " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_SUB:
			cout << "SUB " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_MUL:
			cout << "MUL " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_DIV:
			cout << "DIV " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_MOD:
			cout << "MOD " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;

		case IR_GT:
			cout << "GT " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_LT:
			cout << "LT " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_GTE:
			cout << "GTE " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_LTE:
			cout << "LTE " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_EQ:
			cout << "EQ " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_NEQ:
			cout << "NEQ " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;

		case IR_AND:
			cout << "AND " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_OR:
			cout << "OR " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_NOT:
		...
		case IR_PARAM:
			...
			break;
		case IR_CALL:
			cout << "CALL " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_RET:
		...
		case IR_ARRAY_LOAD:
			cout << "LOAD " << current->arg1 << " " << current->arg2 << " " << current->result
				 << endl;
			break;
		case IR_ARRAY_STORE:
			cout << "STORE " << current->result << " " << current->arg1 << " " << current->arg2
				 << endl;
			break;
